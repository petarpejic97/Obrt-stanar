...
import com.example.obrtstanar.SendEmailViewModel
import com.example.obrtstanar.ShowPictureViewModel
import com.example.obrtstanar.databinding.ActivitySendEmailBinding
import com.example.obrtstanar.databinding.ActivityShowPictureBinding
...
class SendEmail : AppCompatActivity() {
    ...
    private fun sendEmail(){
        val i = Intent(Intent.ACTION_SEND)
           ...
           i.putExtra(Intent.EXTRA_EMAIL, arrayOf("petar.pejic@outlook.com"))
