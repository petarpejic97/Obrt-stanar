...
import com.stanar.obrtstanar.Klase.FirebaseClass.Failure
...
import com.stanar.obrtstanar.ReportFailureViewModel
import com.stanar.obrtstanar.databinding.FragmentProfileBinding
import com.stanar.obrtstanar.databinding.FragmentReportFailureBinding
...
class ReportFailure : Fragment(), AdapterView.OnItemSelectedListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if ( requestCode == 0 && resultCode == Activity.RESULT_OK && data != null){
            ...
            binding.loadedPicture.setImageResource(R.drawable.ciclefinished)
